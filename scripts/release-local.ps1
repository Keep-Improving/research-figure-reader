...
$localRunReadme = @(
  ...
  "5. Click Settings in the web app, enter your own API key, Base URL, and Model, then click Save and test.",
  "6. To use the browser extension, load the extension folder in Chrome or Edge extension management. In extension Options, keep the backend URL as http://127.0.0.1:8787.",
  "",
